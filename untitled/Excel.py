                    ...
                    try:
                        ...
                        if row[0]:
                            ...
                            for a in list[::-1]:
                                        ...
                                        cr1 = db1.cursor()
                                        sql1 = "insert into sm(user_name,SRC_TELE_NUM,DEST_TELE_NUM,MSG,sm_seq_id,SET_SEND_TIME)values('joke','106573073830','%s','%s',SM_SEQ.nextval,sysdate)" % (telNum,a)
                                        cr1.execute(sql1)
                                        cr1.close()
                                        db1.commit()
                                        db1.close()
